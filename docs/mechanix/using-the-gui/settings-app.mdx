...
### 1. Network
    ...
    1. To Forget connected/saved network go to network information from network list: \
        ...
        <Video src="https://web-assets.mecha.so/developers-v1/launcher/forget-connected-network.mp4">
            Your browser does not support the video tag.
        </Video>
    2. To forget the saved network go to saved network list & tap on trash icon.
        <Video src="https://web-assets.mecha.so/developers-v1/launcher/forget-saved-network.mp4">
            Your browser does not support the video tag.
        </Video>
...
### 2. Display
    ...
    **Adjust Brightness:** Control the screen brightness to suit your environment and viewing preferences by scrolling the brightness widget.
    <Video src="https://web-assets.mecha.so/developers-v1/launcher/settings-display.mp4">
            Your browser does not support the video tag.
    </Video>
...
### 3. Battery
    ...
    **Power Mode**:\
    ...
    <Video src="https://web-assets.mecha.so/developers-v1/launcher/settings-battery.mp4">
            Your browser does not support the video tag.
    </Video>
...
### 4. Sound
    ...
    **Input Volume**: Control selected input device volume.
    <Video src="https://web-assets.mecha.so/developers-v1/launcher/settings-sound.mp4">
            Your browser does not support the video tag.
    </Video>
...
### 5. About
    ...
    OS name, \
    Kernel version.
    <Video src="https://web-assets.mecha.so/developers-v1/launcher/settings-about-comet.mp4">
            Your browser does not support the video tag.
    </Video>
