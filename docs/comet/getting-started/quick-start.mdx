...
<S.Column>
  The Mecha Mecha Comet  device is an open-source handheld computer with focus on
...
<S>
    <S.Step>
        <S.Details>
            ...
            You can use any regular Type-C or USB based power supply for the Mecha Comet  that you have lying around.


            The recommended power supply for the Mecha Comet  is a 5V, 2.5A (12.5W). Plug the Type-C from your charger to the base Type-C port found at the bottom of the device.
    ...
    <S.Step>
        <S.Details>
           ...
           You will see the Mecha logo on the screen and the device will start booting up its operating system.
            ...
            ![Image](../../../src/images/mecha_power_button.jpg)
            ![Image](../../../src/images/mecha_power_on.png)
    ...
    <S.Step>
        <S.Details>
            ...
            To connect the Mecha Comet  to your wireless network, you can use the Settings App available on the Home Screen and:
            ...
            ![Image](../../../src/images/disabled_wireless.jpg)
