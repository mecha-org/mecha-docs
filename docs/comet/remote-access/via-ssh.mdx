...
- You will need the PuTTY application on Windows. Follow [this tutorial](http://developers.mecha.so/comet/connectivity/using-putty-on-windows) on how to use PuTTY.
