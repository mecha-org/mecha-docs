...
<img className="img-rounded" src="/assets/serial-console/connect-uart.png" alt="Launch Terminal" style={{ maxWidth: '100%', height: 'auto' }} />
...
<img className="img-rounded" src="/assets/serial-console/breakout-extension.png" alt="Launch Terminal" style={{ maxWidth: '100%', height: 'auto' }} />
...
<S> 
    ...
    <S.Step>
        <S.Details>
         ...
         <img className="img-rounded" src="/assets/serial-console/device-manager-com-port.png" alt="Device Manager" style={{ maxWidth: '100%', height: 'auto' }} />
        </S.Details>
    </S.Step>
</S>
...
<S> 
    ...
    <S.Step>
        <S.Details>
          ...
          <img className="img-rounded" src="/assets/serial-console/putty-configuration.png" alt="Putty Configuration" style={{ maxWidth: '100%', height: 'auto' }} />
        </S.Details>
    </S.Step>
    <S.Step>
        <S.Details>
