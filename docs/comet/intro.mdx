...
<Banner path="/img/comet/mecha-comet-banner.png" title="Mecha Comet" />
...
<SmallGrid>
    ...
    [**Remote Access** Ways and options to remotely access your device.](comet/remote-access/introduction-to-remote-access)

    [**Building Apps** Language or platform wise development guides.](comet/development/cpp)

    [**Emulation** Configure the Comet to run different platform binaries and games ](comet/emulation)

    [**Networking** Advanced networking related guides and references ](comet/networking)

    [**Machine Learning** Setup and run different ML platforms such as Tensorflow and LLMs](comet/machine-learning/running-tensorflow)
